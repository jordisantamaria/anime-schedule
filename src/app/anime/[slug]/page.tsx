      ...
      <div className="flex flex-col gap-5 sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <table className="mt-4 text-sm">
            <tbody className="[&_td]:py-1 [&_td]:pr-6 [&_td:first-child]:text-text-muted [&_td:first-child]:font-normal [&_td:last-child]:font-bold">
              <tr>
                <td>曜日</td>
              ...
              {anime.platforms.map((pid) => {
                ...
                return (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 rounded bg-bg-card px-3 py-1.5 text-sm font-bold text-text-primary transition-colors hover:text-accent"
                  >
                    <span
